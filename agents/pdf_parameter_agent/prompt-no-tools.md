...
- extracts one table, named "Disclosed Vulnerabilities for legacy findings",
  in the PDF file as records.
- Merges data deterministically enriching the PDF table, using the inputs from CSV file matching the right endpoind.
